...
MRESULT = function(n)
{
  ...
  else(n == 2)#Head of groundwater
  {
    
  }
  else(n == 3)#Drainage Max water height at Hooge Raam
  {
    
  }
  else(n == 4) #Drainage of the groundwater
  {
    
  }
  else(n == 5) #Lag of maximum precipitation and the maximum head of groundwater
  {
