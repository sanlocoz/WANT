...
```{r eval = TRUE}
scale = list(GW.kD = 0.5*GW.kD, C_ditch = 0.6*C_ditch, H_drainage = 0.3, C_surface = 0.6*C_surface, H_surface = 0.3, GW.S = 0.4*GW.S, HR.weir.crest = 0.10, HR.weir.width = 0.05, HR.n = 0.25*HR.n, HR.b = 0.3, HR.m = 0.2*HR.m, Pattern.maximum.rate = 0.5*Pattern.maximum.rate, Pattern.storm.length = 1/24)#list of the scale of variation of the model parameters
...
colnames(varRes) <- c('var1', 'var2', 'var3', 'var4', 'var5')
print(varRes)
```
</div>
...
knitr::kable(as.data.frame(varRes)*100, caption = "percentage local sensitivities",align="c")
