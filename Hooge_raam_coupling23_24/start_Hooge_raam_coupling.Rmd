...
```{r eval = TRUE}
scale = list(GW.kD = 0.5*GW.kD, C_ditch = 0.7*C_ditch, H_drainage = H_drainage, C_surface = C_surface, H_surface = H_surface, GW.S = GW.S, HR.weir.crest = HR.weir.crest, HR.weir.width = HR.weir.width, HR.n = HR.n, HR.b = 0.3, HR.m = HR.m)#list of the scale of variation of the model parameters
