...
\includegraphics{start_Hooge_raam_coupling_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{start_Hooge_raam_coupling_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\CommentTok{\#Water level far upstream}
\NormalTok{tosolve }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(a)\{}\FunctionTok{return}\NormalTok{ (}\FunctionTok{HR.Qequi}\NormalTok{(a)}\SpecialCharTok{{-}}\NormalTok{Q)\}}
\NormalTok{aequi }\OtherTok{=} \FunctionTok{nleqslv}\NormalTok{(}\DecValTok{1}\NormalTok{,tosolve)}\SpecialCharTok{$}\NormalTok{x}
\FunctionTok{print}\NormalTok{(aequi)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Water level at the weir}
\NormalTok{tosolve }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(a)\{}\FunctionTok{return}\NormalTok{ (}\FunctionTok{HR.weirQ}\NormalTok{(a)}\SpecialCharTok{{-}}\NormalTok{Q)\}}
...
\includegraphics{start_Hooge_raam_coupling_files/figure-latex/unnamed-chunk-16-1.pdf}
